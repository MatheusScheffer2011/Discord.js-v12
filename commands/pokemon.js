...
message.channel.send("Buscando informações para a API").then(msg => {
  get(options).then(body => {
    ...
    .setColor("#ff2050")
    .setFooter(`Fraqueza de Pokemon. - ${body.info.weakness}`, `https://courses.cs.washington.edu/courses/cse154/webservices/pokedex/${body.images.weaknessIcon}`)
