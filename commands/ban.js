...
exports.run = (bot, message, args) => {
  let user = message.mentions.users.first() || bot.users.cache.get(args[0])
    ...
    if (!membro) return message.reply('🚨 | O Comando  nao é assim digite m!ban @usuário Motivo.')
    ...
    if(!message.guild.me.hasPermission("BAN_MEMBERS")) return message.channel.send('🚨 | Desculpe, Mas eu preciso da permissão **Banir Membros** para poder executar este comando!')
