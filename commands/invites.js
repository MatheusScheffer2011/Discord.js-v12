    ...
    try {
        ...
        if (!message.guild.me.hasPermission("MANAGE_GUILD")) {
            embed.setAuthor("Erro")
                 .setDescription("Não tenho acesso aos convites do servidor, verifique minhas permissões!");
        ...
        if (invites.size === 0) {
              ...
              .setColor('BLACK')
              .setAuthor("Erro")
              .setDescription("Atualmente não existem convites criados neste servidor!");
