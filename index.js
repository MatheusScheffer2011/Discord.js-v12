...
client.on('message', async message => {
     ...
     if(db.has(`afk-${message.author.id}+${message.guild.id}`)) {
        ...
        message.reply(`Você não está mais afk! (${info})`)
    }
    ...
    let thurlegal = new Discord.MessageEmbed()
 .setDescription(`Não entendi! 🤖 Não consegui encontrar o comando \`${command}\` em meu sistema! Utilize m!help para ver os meus comandos!`)
  message.channel.send(thurlegal)
